  ...
  return (
    <Main>
      ...
      <Box px={[2, 2, 8, 12]} pt={2} pb={12}>
        ...
        <Text as="figcaption" textStyle="figcaption" fontSize="baseline" textAlign="right">
          {t('unicode-consortium')}
        </Text>
        <Wrap spacing={['10px', '20px', '30px', '30px']} justify="center">
          <WrapItem
            flex={1}
            w={['90vw', '85vw', '340px', '380px']}
            minW={['80vw', '40vw', '40vw', '300px']}
            p={4}
            bg={colorMode === 'light' ? aboutBoxStyle.box1_bg_light : aboutBoxStyle.box1_bg_dark}
            borderRadius={5}
          >
            <Flex direction="column" gap={3}>
              ...
              <Text>
                ...
                <br />
                {t('short-name')}: <strong>grinning face with smiling eyes</strong>
              </Text>
              <Spacer />
              <Text fontStyle="italic" fontWeight="semibold" fontSize="sm">
                ...
                ,
                <Link href="https://en.wikipedia.org/wiki/Unicode" ml={1} fontWeight="normal">
                  wikipedia
                </Link>
              </Text>
            </Flex>
          ...
          <WrapItem
            ...
            w={['90vw', '85vw', '340px', '380px']}
            p={4}
            bg={colorMode === 'light' ? aboutBoxStyle.box2_bg_light : aboutBoxStyle.box2_bg_dark}
            borderRadius={5}
          >
          ...
          <WrapItem
            ...
            minW={['80vw', '40vw', '40vw', '300px']}
            p={4}
            bg={colorMode === 'light' ? aboutBoxStyle.box3_bg_light : aboutBoxStyle.box3_bg_dark}
            borderRadius={5}
          >
            <Flex direction="column" gap={3}>
              <Text>
              ...
              <Text fontStyle="italic" fontWeight="semibold" fontSize="sm">
                {t('source')}:
                <Link href="https://en.wikipedia.org/wiki/UTF-16" ml={1} fontWeight="normal">
                  wikipedia
                </Link>
              </Text>
            </Flex>
          ...
          <WrapItem
            ...
            minW={['80vw', '40vw', '40vw', '300px']}
            p={4}
            bg={colorMode === 'light' ? aboutBoxStyle.box6_bg_light : aboutBoxStyle.box6_bg_dark}
            borderRadius={5}
          >
            <Flex direction="column" gap={3}>
              <Text>
          ...
          <WrapItem
            ...
            minW={['80vw', '40vw', '40vw', '300px']}
            p={4}
            bg={colorMode === 'light' ? aboutBoxStyle.box4_bg_light : aboutBoxStyle.box4_bg_dark}
            borderRadius={5}
          >
            <Flex direction="column" gap={3}>
              <Text>
              ...
              <Text fontStyle="italic" fontWeight="semibold" fontSize="sm">
                {t('source')}:
                <Link href="https://en.wikipedia.org/wiki/ASCII" ml={1} fontWeight="normal">
                  wikipedia
                </Link>
              </Text>
            </Flex>
          ...
          <WrapItem
            ...
            minW={['80vw', '40vw', '40vw', '300px']}
            p={4}
            bg={colorMode === 'light' ? aboutBoxStyle.box5_bg_light : aboutBoxStyle.box5_bg_dark}
            borderRadius={5}
          >
            <Flex direction="column" gap={3}>
              <Text>
